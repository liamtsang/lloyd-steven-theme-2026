if (!customElements.get("product-info")) {
  customElements.define(
    ...
    class ProductInfo extends HTMLElement {
      ...
      getSelectedVariantInventory(productInfoNode) {
        const selectedVariant = productInfoNode.querySelector(
          "variant-selects [data-selected-inventory]"
        )?.innerHTML;
        return !!selectedVariant ? JSON.parse(selectedVariant) : null;
      }
      ...
      handleUpdateProductInfo(productUrl) {
        return (html) => {
          ...
          const variantInventory = this.getSelectedVariantInventory(html);
          ...
          if ((variantInventory == 0) & (variant.available == true)) {
            this.productForm?.toggleSubmitButton(false, "madeToOrder");
          } else {
